...
const std::unordered_map<string, ShaderType> TypeManager::BuiltinTypes_ {
	...
	{ "ROITexels", { ShaderBaseType::ROTexels, ImageDims::Buffer, ShaderBaseType::SInteger, 4 } },
	{ "ROUTexels", { ShaderBaseType::ROTexels, ImageDims::Buffer, ShaderBaseType::UInteger, 4 } },
